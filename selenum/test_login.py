...
class Test_login:
    ...
    def login_to_acoount(self, driver, uesr_info: list):
        """
        :param driver:
        :param uesr_info:
        :return: NAN
    ...
    def test_login_1(self):
        ...
        self.login_to_acoount(driver, TEST_CASES['valid'])
        time.sleep(5)
    ...
    def test_login_2(self):
        driver = set_driver()
        time.sleep(2)
        self.login_to_acoount(driver, TEST_CASES['not valid 1'])
    ...
    def test_login_3(self):
        driver = set_driver()
        time.sleep(2)
        self.login_to_acoount(driver, TEST_CASES['not valid 2'])
    ...
    def test_login_4(self):
        driver = set_driver()
        time.sleep(2)
        self.login_to_acoount(driver, TEST_CASES['not valid 3'])
    ...
    def test_login_5(self):
        driver = set_driver()
        time.sleep(2)
        self.login_to_acoount(driver, TEST_CASES['not valid 4'])
    ...
    def test_login_6(self):
        ...
        link = lost_password.find_element(By.TAG_NAME, 'a')
        link.click()
        logging.info("link - clicked")
        time.sleep(1)

        page_subheading = driver.find_element(By.TAG_NAME, 'h1')
        ...
        sub = driver.find_element(By.CLASS_NAME, 'submit')
        button = sub.find_element(By.TAG_NAME, 'button')
